...
<main class="max-w-4xl mx-auto px-6 mt-10">
    ...
    <form action="<?= BASE_URL ?>/index.php?url=trip/update/<?= $trip->id ?>" method="POST" enctype="multipart/form-data" class="grid grid-cols-2 gap-4">
        ...
        <div class="col-span-2 flex flex-col gap-1">
            ...
            <textarea id="attractions" name="attractions" rows="3"
        ...
        <div class="col-span-2 flex flex-col gap-1">
            ...
            <?php if (!empty($trip->images)): ?>
                ...
                <p class="text-xs text-orange-600 mb-2">Upozornění: Pokud nahrajete nové soubory, staré budou přepsány.</p>
            <?php endif; ?>
            <label for="images"
